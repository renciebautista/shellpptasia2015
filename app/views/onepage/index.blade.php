...
<div class="row">
	...
	<div class="col-lg-12">
		...
		<p>This year’s programme will include four interactive sessions in which a <strong>diverse group of leading experts – amongst others Saya Kitasei</strong> (Head of Resilience at Xyntéo), <strong>Architect Rajeev Kathpalia</strong> (urban planning expert on smart city development from Vastu Shilpa Foundation), <strong>Holger Dalkmann</strong> (Director at Embarq, a World Resources Institute programme on sustainable transport), and <strong>Luke Beckman</strong> (American Red Cross’ Situational Manager and expert on disaster management) – will embark on the search for greater resilience through interactive presentations, interviews and panel discussions.</p>
