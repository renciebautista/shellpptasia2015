...
<div class="row">
	<div class="col-lg-12">
		...
		<ul>
			...
			<li><strong>Resilience and it’s Implications on Business</strong> - shares stories of innovative disaster mitigation and management as well as rehabilitation in response to climate risks </li>
		</ul>
		<p><strong>Aljazeera Broadcast Journalist Maryam Nemazee</strong> will moderate the forum, which will also be live streamed via <strong>Rappler</strong>.</p>
		...
		<ul>
			<li><a href="https://www.youtube.com/watch?v=7jKg_gh_fBs">Watch the Shell Powering Progress Together – Asia 2014 Lookback Film</a></li>
			<li><a href="http://www.shell.com/global/aboutshell/events/powering-progress-together/what-is-ppt.html">Know more about Shell Powering Progress Together</a></li>
		</ul>
	</div>
</div>
@stop